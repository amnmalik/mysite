---
title: "Students on Ice: An Antarctic Expedition"
date: 2011-02-14
summary: "On 14 February 2011, I was one of 53 students selected from around the world to join the Students on Ice educational expedition to Antarctica."
tags: ["antarctica", "expedition", "students-on-ice", "polar", "climate"]
---
...
![Holding the Indian flag on the deck of the M/V Ushuaia, Antarctica](flag.png)
...
![Sunset at Brown Bluff, Antarctic Peninsula](sunset.png)
...
![Antarctic fur seal at Brown Bluff](fur-seal.webp)
...
![Digging snow pits to learn more about the snow](snow-pit.png)
...
![A massive iceberg on the Antarctic Peninsula](iceberg.webp)
...
The return crossing of the Drake Passage was not as forgiving as the one that had carried us south. A storm caught up with the ship, and for the better part of a day the waves rose as high as 35 feet — high enough that, for a moment, it felt as though the ship might break apart under them. We rode it out below deck, waiting for it to pass, grateful when it finally did that we came through unhurt. If the outbound crossing had been a stroke of luck, this one was a plain reminder of how little control you have once you're out on that water — and of how much power the ocean holds over anything built to cross it.
